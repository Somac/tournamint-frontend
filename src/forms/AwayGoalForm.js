...
AwayGoalForm = reduxForm({
  form: 'awaygoal',
  onSubmitSuccess: afterSubmit,
}, mapStateToProps)(AwayGoalForm)

const selector = formValueSelector('awaygoal')
AwayGoalForm = connect(
  state => {
